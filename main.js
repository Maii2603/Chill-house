...
@Pokemon Unite Ping*/
  ...
  if(msg.content.startsWith(`${prefix}casinokey`) && msg.author.id === "763635514158350356"){
    ...
    const arcadeEmbed = {
      embed:{
        title:"ARCADE PASS", 
        description:"━━━━━━━━━\n\n\n\n Hit the invader 👾 below to unclock Arcade Games\n\n\n\n━━━━━━━━━", 
        color:0xff0000
      }
    }
    bot.createMessage(msg.channel.id,arcadeEmbed);
   ...
   if(msg.content.startsWith(`${prefix}fishery`) && msg.author.id === "763635514158350356"){
    const arcadeEmbed = {
      embed:{
        title:"FISHERY PASS", 
        description:"━━━━━━━━━\n\n\n\n Hit the fish 🐟 below to unclock Fishery\n\n\n\n━━━━━━━━━", 
        color:0xff0000
      }
    }
    bot.createMessage(msg.channel.id,arcadeEmbed);
...
bot.on("messageReactionAdd", (msg, emoji, reactor) => {
 ...
 if (emoji.name === "🎉" && msg.channel.id === "887161392988311612") {
  ...
  if (emoji.name === "👾" && msg.channel.id === "907063060945051678") {
    ...
    if (emoji.name === "🐟" && msg.channel.id === "907068193393221643") {
    bot.addGuildMemberRole(msg.channel.guild.id, reactor.id, "907070257485733908")
  }
...
bot.on("messageReactionRemove", (msg, emoji, reactor) => {
 ...
 if (emoji.name === "🍿" && msg.channel.id === "887161392988311612") {
  ...
  if (emoji.name === "🐟" && msg.channel.id === "907068193393221643") {
    bot.removeGuildMemberRole(msg.channel.guild.id, reactor, "907070257485733908")
  }
...
bot.on("guildMemberAdd",(guild,member) => {
 const welcomeEmbed = {
   embed:{
     ...
     fields:[{
       name:"RULES", 
       value:"<:froggy_arrow:904762712217780316> Read the server rules in <#886591125866049597>"
     },{
       name:"ROLES", 
       value:"<:froggy_arrow:904762712217780316> Get your roles in <#887161392988311612>"
     },{
       name:"INTRODUCTION", 
       value:"<:froggy_arrow:904762712217780316> Introduce yourself in <#898573321661210644>"
     }], 
     image:{
